...
export async function loadCartDrawerAction({ locale }: CartActionInput) {
  return withCartAction(locale, (identity) => getCartSnapshot(identity), "LOAD_FAILED");
}
...
export async function addCartItemAction({
  ...
  return withCartAction(locale, (identity) => addCartItem({
    ...identity,
    quantity,
    variantId,
  }), "ADD_FAILED");
...
export async function updateCartItemQuantityAction({
  ...
  return withCartAction(locale, (identity) => updateCartItemQuantity({
    ...identity,
    itemId,
    quantity,
  }), "UPDATE_FAILED");
...
export async function removeCartItemAction({
  ...
  return withCartAction(locale, (identity) => removeCartItem({
    ...identity,
    itemId,
  }), "REMOVE_FAILED");
}
