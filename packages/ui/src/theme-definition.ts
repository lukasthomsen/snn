...
export function themeToCssVariables(theme: ThemeDefinition) {
  return {
    ...
    "--color-inverse": theme.color.actionPrimaryBg,
    "--color-inverse-soft": `color-mix(in srgb, ${theme.color.actionPrimaryBg} 94%, ${theme.color.surface})`,
    ...
    "--color-accent-surface-strong": theme.color.surfaceStrong,
    ...
    "--color-action-secondary-bg-hover": theme.color.surfaceMuted,
    ...
    "--color-success-surface": `color-mix(in srgb, ${theme.color.success} 10%, ${theme.color.canvas})`,
    ...
    "--color-warning-surface": `color-mix(in srgb, ${theme.color.warning} 8%, ${theme.color.canvas})`,
    ...
    "--color-danger-surface": `color-mix(in srgb, ${theme.color.danger} 10%, ${theme.color.canvas})`,
    "--color-danger-surface-strong": `color-mix(in srgb, ${theme.color.danger} 16%, ${theme.color.canvas})`,
    ...
    "--color-focus-outline": theme.color.textPrimary,
    ...
    "--color-backdrop-soft": `linear-gradient(180deg, color-mix(in srgb, ${theme.color.surface} 58%, transparent), color-mix(in srgb, ${theme.color.surface} 12%, transparent))`,
    ...
    "--control-radius": theme.radius.md,
    "--control-disabled-opacity": "0.52",
    "--card-bg": theme.color.canvas,
    ...
    "--overlay-surface": theme.color.canvas,
    ...
    "--chrome-header-bg": "rgba(250, 250, 252, 0.8)",
    "--chrome-header-bg-docked": "rgba(250, 250, 252, 0.8)",
    "--chrome-header-backdrop-filter": "saturate(180%) blur(20px)",
    "--chrome-header-shadow": "none",
    "--chrome-footer-bg": theme.color.canvas,
